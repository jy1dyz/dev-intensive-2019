...
class MainActivity() : AppCompatActivity(), View.OnClickListener {
    ...
    /**
     * Вызывается, когда Activity начнет взаимодейтсвовать с пользователем.
     *
     ...
     * выполнение любых других инициализаций, которые должны происходить, кода Activity  вновь активна (камера)
     *
     ...
     * остановка серсисов, подписок, BroadCastReceiver
     *
     * Тут должен быть максимально легкий и быстрый код, чтобы приложение оставалось отзывчивым
     */
     ...
     * Это может произойти при ее уничтожении, или если запущена другая Activity (существующая или новая)
     * перекрывшая окно текущей Activity
     *
     * запись в базу данных
     * приостановка сложной анимации
     * приостановка потоков, отслеживания показаний датчиков, запросов к GPS, таймеров, сервисов иди других процессов,
     * которые нужны исключительно для обновления пользовательского интерфейса
     *
     * Не вызывается при вызове метода finish() y Activity
     */
